        ...
        <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-6 w-full mb-10 px-10">
                <div className="bg-white shadow-xl rounded-lg max-w-sm ">
                    ...
                    <div className="px-5 pb-5 grid grid-cols-2">
                        ...
                        <div className="flex flex-col items-end justify-center pr-5">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" fill="#ff0000" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#ff0000" className="w-7 h-7 mb-2 border-gray-200 border-2  rounded-full shadow-inner p-1 bg-gray-200">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z" />
                            </svg>

                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-7 h-7 p-1 text-white bg-orange-600 rounded-full">
                ...
                <div className="bg-white shadow-xl rounded-lg max-w-sm border-orange-600 border-[1px]">
                    <a href="#">
                        <img className="rounded-t-lg p-8" src="/images/food3.png" alt="product image" />
                    </a>
                    <div className="px-5 pb-5 grid grid-cols-2">
                        <div className="info">
                            <a href="#">
                ...
                <div className="bg-white shadow-xl rounded-lg max-w-sm ">
                    <a href="#">
                        <img className="rounded-t-lg p-8" src="/images/food5.png" alt="product image" />
                    </a>
                    <div className="px-5 pb-5 grid grid-cols-2">
                        <div className="info">
                            <a href="#">
